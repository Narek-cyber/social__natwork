...
Source Database       : social_narek

Target Server Type    : MYSQL
Target Server Version : 50505
File Encoding         : 65001

Date: 2020-11-17 16:50:03
*/
...
CREATE TABLE `notifications` (
  ...
  `myphoto` varchar(255) NOT NULL DEFAULT '',
  `otheruserphoto` varchar(255) NOT NULL DEFAULT '',
  PRIMARY KEY (`id`) USING BTREE,
  KEY `user1` (`user1`) USING BTREE,
  KEY `user2` (`user2`) USING BTREE,
...
CREATE TABLE `users` (
  ...
  `active_time` int(155) DEFAULT NULL,
  `cover_photo` varchar(255) DEFAULT NULL,
  `cover_photo1` varchar(255) DEFAULT NULL,
  `block_count` int(11) DEFAULT 0,
  `block_time` int(155) DEFAULT NULL,
